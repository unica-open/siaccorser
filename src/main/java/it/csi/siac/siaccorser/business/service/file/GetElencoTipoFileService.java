...
public class GetElencoTipoFileService extends
		BaseService<GetElencoTipoFile, GetElencoTipoFileResponse> {
	...
	@Transactional
	@Override
	public GetElencoTipoFileResponse executeService(GetElencoTipoFile serviceRequest) {
		return super.executeService(serviceRequest);
	}

	@Override
	protected void execute() {
		res.setElencoTipoFile(fileDad.getElencoTipoFileByIdAccount(req.getAccount()));

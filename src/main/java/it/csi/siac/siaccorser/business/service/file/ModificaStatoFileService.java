...
public class ModificaStatoFileService extends
		BaseService<ModificaStatoFile, ModificaStatoFileResponse> {
	...
	@Transactional
	@Override
	public ModificaStatoFileResponse executeService(ModificaStatoFile serviceRequest) {
		return super.executeService(serviceRequest);
	}

	@Override
	protected void execute() {
		fileDad.updateStatoFile(req.getUid(), req.getStato(), req.getRichiedente().getOperatore().getCodiceFiscale());
